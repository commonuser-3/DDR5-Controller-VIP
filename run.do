...
add wave -group "AXI MASTER VIP" -radix hex sim:/top/axi_pcie_intf/*
...
add wave -r sim:/top/u_phy/u_zq_cal/*
...
# =============================================================
# 10. PHY commands (ACT/WR/RD) + write/read data focused view
#     cs_n LOW = command valid for that channel.
#     During DQS/DQ data burst, cs_n can return HIGH because the
#     command was already captured earlier and data is strobed by DQS.
# =============================================================
...
add wave -group "CH0 CMD"               sim:/top/u_phy/cai0
add wave -group "CH0 CMD" -radix binary sim:/top/u_phy/ca0_original
add wave -group "CH0 CMD" -radix unsigned sim:/top/u_phy/ca0_ones
...
add wave -group "CH1 CMD"               sim:/top/u_phy/cai1
add wave -group "CH1 CMD" -radix binary sim:/top/u_phy/ca1_original
add wave -group "CH1 CMD" -radix unsigned sim:/top/u_phy/ca1_ones
...
add wave -position insertpoint  sim:/top/u_phy/clk_enable
...
add wave -group "PHY CA SERIAL"          sim:/top/dram_if/cai
add wave -group "PHY CA SERIAL" -radix binary sim:/top/u_dram/ca_raw_r
add wave -group "PHY CA SERIAL"          sim:/top/u_dram/cai_r

# =============================================================
# 11. DRAM side - keep memory-module visibility
# =============================================================
add wave -r sim:/top/dram_if/*
add wave -r sim:/top/u_dram/*
