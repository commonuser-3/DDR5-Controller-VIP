  ...
  function automatic void encode_cmd(
    ...
    unique case (req.cmd)
      ...
      CMD_ACT: begin
        ...
        phases[0].rise[6]   = req.ba[0];
        phases[0].rise[7]   = req.ba[1];
        phases[0].rise[8]   = req.bg[0];
        phases[0].rise[9]   = req.bg[1];
        phases[0].rise[10]  = 1'b0;
        phases[0].fall = phases[0].rise;
        phases[1].cs_n = 1'b1;
        phases[1].rise = '0;
        phases[1].rise[9:0]  = req.row[13:4];
        phases[1].rise[10]   = req.row[14];
        phases[1].rise[11]   = req.row[15];
        phases[1].rise[12]   = 1'b0;
        phases[1].rise[13]   = 1'b0;
      ...
      CMD_RD: begin
        phases[0].rise = '0;
        phases[0].rise[0]   = 1'b1;
        phases[0].rise[1]   = 1'b0;
        phases[0].rise[2]   = 1'b1;
        phases[0].rise[3]   = 1'b1;
        ...
        phases[1].cs_n = 1'b1;
        phases[1].rise = '0;
        phases[1].rise[0]   = req.col[2];
        phases[1].rise[7:1] = req.col[9:3];
        phases[1].rise[8]   = 1'b0;
        phases[1].rise[10]  = 1'b1;
        phases[1].rise[11]  = 1'b0;
        phases[1].fall = phases[1].rise;
      end
