...
//--------------------------------------------------------------------------------------------------------
// BUSCHOP8 / BC8 testcase
// Organization: ELOBCHIP
//--------------------------------------------------------------------------------------------------------

class buschop8_sequence extends axi_sequence;
    `uvm_object_utils(buschop8_sequence)
    ...
    task body();
        ...
        assert(wr_tx.randomize() with {
            wr_rd == WRITE_ONLY;
            // Row[3:0], BG and BA are high, so ACT cycle-1 CA has 8 ones.
            awaddr == 32'h000F_E020;//00000000 0000 /1111 /11/1/00000 00/1/00000

	     //CA13 CA12 CA11 CA10 CA9 CA8 CA7 CA6 CA5 CA4 CA3 CA2 CA1 CA0
           //        CID2 CID1 CID0 BG2 BG1 BG0 BA1 BA0 R3 R2 R1 R0  0   0
